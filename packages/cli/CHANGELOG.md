...
- BugFix: Updated `zowe daemon enable` help text to warn users that the Zowe bin directory must be manually added to PATH after enabling daemon mode. [#2717](https://github.com/zowe/zowe-cli/pull/2717)
